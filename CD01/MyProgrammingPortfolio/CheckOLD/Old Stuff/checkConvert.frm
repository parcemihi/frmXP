...
Option Explicit
Dim totChks As Integer
Dim totDeps As Integer
Dim CheckIndx As Integer
Dim DepositIndx As Integer
Dim i As Integer
Dim isCheck As Boolean
Dim Checks(0 To 5000) As WChk
Private Type WChk
    c1Numb As String
    c2Date As String
    c3Desr As String
    c4Amnt As String
End Type
Dim Deposits(0 To 5000) As DChk
Private Type DChk
    d1Indx As String
    d2Date As String
    d3Desr As String
...
DepositIndx = 0
    Open App.Path & "\checks.k" For Input As #1
        Do Until EOF(1)
            Input #1, Checks(totChks).c1Numb, Checks(totChks).c2Date, Checks(totChks).c3Desr, Checks(totChks).c4Amnt
            totChks = totChks + 1
        Loop
    Close #1
...
Dim retVal
    Select Case isCheck
        Case True
            ...
            Checks(CheckIndx).c2Date, _
            Checks(CheckIndx).c3Desr, _
            Checks(CheckIndx).c4Amnt)
        Case False
            retVal = navigate_Entry _
...
Function navigate_Entry(Index As String, Optional F2 As String, Optional F3 As String, Optional F4 As String)
    Text1(0).Text = Index
    Text1(1).Text = F2
    Text1(2).Text = F3
    Text1(3).Text = F4
