...
Option Explicit
Global msg62 As String, msg6 As String
Global filename As String
Dim i As Integer, x As String, y As String

'Dim filename As String

Public Function ErrorHandler(ErrorNumber As Integer)
Select Case Err.Number
Case 3 'Return without GoSub
Case 5 'Invalid procedure call
Case 6 'Overflow
msg6 = MsgBox("Please check the quantity of items you typed in. The number is beyond the scope of this program.", vbCritical)
...
Case 52 'Bad file name or number
    Close #1
    Open App.Path & filename For Output As #52
...
Case 53 'File not found
    ...
    Case "\pricelist.dat"
    Open App.Path & filename For Output As #53
    Write #53, 50#, 150#, 450#, 75#, 225#, 675#, 100#, 300#, 900#, 0#
    Close #53
    Case Else
    Open App.Path & filename For Output As #53
    Close #53
...
Case 62 'Input past end of file
    Close #1
    msg62 = LCase(InputBox("Please enter the name of the purchase order database.", "Create new database"))
    For i = 1 To Len(msg62)
    Select Case Mid(msg62, i, 1)
    Case Chr(34), Chr(42), Chr(47), Chr(58), Chr(60), Chr(62), Chr(65), Chr(92), Chr(124)
        y = "A filename can not contain any of the following characters." & Chr(10) & Chr(13) & "                " & Chr(92) & " " & Chr(47) & " " & Chr(58) & " " & Chr(42) & " " & Chr(63) & " " & Chr(34) & " " & Chr(60) & " " & Chr(62) & " " & Chr(124)
        x = MsgBox(y, vbCritical, "Database initialization failed")
    Resume
    End Select
    Next i
    If msg62 = "" Then
    ...
    End If
    Close #1
    Open App.Path & "\appth.dat" For Append As #62
    Write #62, msg62 & ".dat"
    Close #62
    Open App.Path & filename For Input As #1
'    Input #1, CustData

'    Form1.LoadCustomer_datafiles
