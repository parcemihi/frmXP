...
Chess.pieces(1).Picture = LoadPicture(App.Path & "\images\RW.gif")
Chess.pieces(2).Picture = LoadPicture(App.Path & "\images\NW.gif")
Chess.pieces(3).Picture = LoadPicture(App.Path & "\images\BW.gif")
Chess.pieces(4).Picture = LoadPicture(App.Path & "\images\QW.gif")
Chess.pieces(5).Picture = LoadPicture(App.Path & "\images\KW.gif")
Chess.pieces(6).Picture = LoadPicture(App.Path & "\images\PW.gif")
Chess.pieces(7).Picture = LoadPicture(App.Path & "\images\RB.gif")
Chess.pieces(8).Picture = LoadPicture(App.Path & "\images\NB.gif")
Chess.pieces(9).Picture = LoadPicture(App.Path & "\images\BB.gif")
Chess.pieces(10).Picture = LoadPicture(App.Path & "\images\QB.gif")
Chess.pieces(11).Picture = LoadPicture(App.Path & "\images\KB.gif")
Chess.pieces(12).Picture = LoadPicture(App.Path & "\images\PB.gif")
End Function
...
Dim i As Integer
Board_Layout(0) = 1: Board_Layout(1) = 2: Board_Layout(2) = 3: Board_Layout(3) = 4: Board_Layout(4) = 5: Board_Layout(5) = 3: Board_Layout(6) = 2: Board_Layout(7) = 1
Board_Layout(8) = 6: Board_Layout(9) = 6: Board_Layout(10) = 6: Board_Layout(11) = 6: Board_Layout(12) = 6: Board_Layout(13) = 6: Board_Layout(14) = 6: Board_Layout(15) = 6
For i = 16 To 47
    Board_Layout(i) = 0
Next i
Board_Layout(48) = 12: Board_Layout(49) = 12: Board_Layout(50) = 12: Board_Layout(51) = 12: Board_Layout(52) = 12: Board_Layout(53) = 12: Board_Layout(54) = 12: Board_Layout(55) = 12
Board_Layout(56) = 7: Board_Layout(57) = 8: Board_Layout(58) = 9: Board_Layout(59) = 10: Board_Layout(60) = 11: Board_Layout(61) = 9: Board_Layout(62) = 8: Board_Layout(63) = 7
End Function
